...
public class SwiftLoader: UIView {
	...
	private let loaderSpinnerMarginSide : CGFloat = 35.0
	private let loaderSpinnerMarginTop : CGFloat = 20.0
	private let loaderTitleMargin : CGFloat = 5.0
    ...
    public class func show(title: String?, animated : Bool) {
      ...
      let currentWindow : UIWindow = (UIApplication.shared.delegate?.window!)!
        ...
        NotificationCenter.default.addObserver(loader, selector: #selector(SwiftLoader.rotated(notification:)),
